...
export class ATokenInstance__getScaledUserBalanceAndSupplyResult {
  value0: BigInt;
  value1: BigInt;
...
export class ATokenInstance extends ethereum.SmartContract {
  static bind(address: Address): ATokenInstance {
    return new ATokenInstance("ATokenInstance", address);
  }
  ...
  try_REWARDS_CONTROLLER(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "REWARDS_CONTROLLER",
      "REWARDS_CONTROLLER():(address)",
      []
  ...
  burn(
    ...
    let result = super.call(
      "burn",
      "burn(address,address,uint256,uint256,uint256):(bool)",
      [
        ethereum.Value.fromAddress(from),
        ethereum.Value.fromAddress(receiverOfUnderlying),
        ethereum.Value.fromUnsignedBigInt(amount),
  ...
  getScaledUserBalanceAndSupply(
    user: Address
  ): ATokenInstance__getScaledUserBalanceAndSupplyResult {
    let result = super.call(
      "getScaledUserBalanceAndSupply",
    ...
    return new ATokenInstance__getScaledUserBalanceAndSupplyResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getScaledUserBalanceAndSupply(
    user: Address
  ): ethereum.CallResult<ATokenInstance__getScaledUserBalanceAndSupplyResult> {
    let result = super.tryCall(
      "getScaledUserBalanceAndSupply",
      "getScaledUserBalanceAndSupply(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(user)]
    ...
    return ethereum.CallResult.fromValue(
      new ATokenInstance__getScaledUserBalanceAndSupplyResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
